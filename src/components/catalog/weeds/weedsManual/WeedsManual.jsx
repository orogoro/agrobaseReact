...
import styles from './WeedsManual.module.scss';

function WeedsManual() {
  ...
  const product = products?.filter(it => it.weed === DiseasesCatalogItem?.id);
  ...
  useEffect(() => {
    ...
    dispatch(catalogOperations.fetchWeedItems(idItem));
