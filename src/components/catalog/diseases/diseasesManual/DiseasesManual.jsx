...
import styles from './DiseasesManual.module.scss';

function DiseasesManual() {
  ...
  const product = products?.filter(
    it => it.disease === DiseasesCatalogItem?.id
  );
  ...
  useEffect(() => {
    ...
    dispatch(catalogOperations.fetchDiseasesProducts(idItem));
